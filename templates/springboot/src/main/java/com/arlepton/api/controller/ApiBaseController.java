package <%=paths.packages.controller%>;
...
import <%=paths.packages.service%>.ApiBaseService;

<% if (jpa) { %>import <%=paths.packages.service%>.RegistryService;
import <%=paths.packages.model%>.Registry;<% } if (nosql && nosql == 'mongo') { %>
import <%=paths.packages.service%>.PersonService;<% } %>

@RestController
public class ApiBaseController {
	
	@Autowired
	private ApiBaseService service;<% if (nosql == 'mongo') { %>
